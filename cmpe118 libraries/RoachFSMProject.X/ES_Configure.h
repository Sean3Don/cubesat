...
typedef enum {
    ...
    LIGHTLEVEL, // signals a light to dark or dark to light transition
    BUMPCHANGE //signals a change in the bumper states
} ES_EventTyp_t;
...
#define EVENT_CHECK_LIST  CheckBumps, CheckLightLevel
...
#define TIMER8_RESP_FUNC PostRoachFSM
